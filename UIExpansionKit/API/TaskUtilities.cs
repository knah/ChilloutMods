...
namespace UIExpansionKit.API
{
    ...
    {
        private static readonly AwaitProvider ourMainThreadQueue = new("UIExpansionKit.ToMainThread"); 
        private static readonly AwaitProvider ourFrameEndQueue = new("UIExpansionKit.FrameEnd"); 
